...
export type AgentResponse = {
     ...
     */
    result: InitializeResponse | AuthenticateResponse | NewSessionResponse | LoadSessionResponse | ListSessionsResponse | ForkSessionResponse | SetSessionModeResponse | PromptResponse | SetSessionModelResponse | ExtResponse;
} | {
    error: _Error;
    id: RequestId;
};
...
export type ClientRequest = {
    id: RequestId;
    method: string;
    params?: InitializeRequest | AuthenticateRequest | NewSessionRequest | LoadSessionRequest | ListSessionsRequest | ForkSessionRequest | SetSessionModeRequest | PromptRequest | SetSessionModelRequest | ExtRequest | null;
};
 ...
 */
export type ErrorCode = -32700 | -32600 | -32601 | -32602 | -32603 | -32000 | -32002 | number;
/**
